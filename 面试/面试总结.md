- 什么是IOC
  ...
  ```
  控制反转，又被称为依赖注入，是一种通过反射机制降低对象之间耦合关系的设计思想。Spring采用IOC的方式把实例化的对象注入到自定义的对象中。
  Demo实现：
  ...
  ![1576905056736](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\1576905056736.png)
